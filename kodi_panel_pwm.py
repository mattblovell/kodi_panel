...
# MIT License
#
# Leveraged from the python-periphery project by Ivan A. Sergeev
#
#   https://github.com/vsergeev/python-periphery
#   Copyright (c) 2015-2023 vsergeev / Ivan (Vanya) A. Sergeev
#
# which is also MIT Licensed.  Changes were made to the
# _write_channel_attr() method for kodi_panel, in order to avoid
# running into python-periphery Issue #57:
#
#   https://github.com/vsergeev/python-periphery/issues/57
#
# I was seeing those errors experimenting with PWM frequency and duty
# cycle values in kodi_panel for the 7.9" Waveshare display.
#
#####################################################################
...
class PWM(object):
    ...
    def _write_channel_attr(self, attr, value):
        """Store value into the file designated by attr"""        
        cmd = "echo " + value + " > " + self._path + "/" + attr
        os.system(cmd)
